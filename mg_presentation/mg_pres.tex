...
\begin{frame}{TODO}
   \begin{itemize}
      \item We need to introduce the Inglis 2010 paper and the name "Inglis" so we can refer to it later.  This just makes referencing a bit more pleasant.
      \item Do we want to add segmentation of C. K.?
   \end{itemize}
\end{frame}
